<template>
  <div>
    ...
    <section>
      ...
      <el-input size="mini" style="width:20%;margin:15px auto;display:block" placeholder="请输入消息标题" v-model="title">
      </el-input>
      ...
      <div class="edit" style="margin-top: 15px">
        <quill-editor ref="textEditor" v-model="articleContent" :options="editorOption"
          style="width:70%;margin:15px auto;height:auto;">
        </quill-editor>
      </div>
    ...
    <main>
      ...
      <article v-for="(item,index) in officalData" :key="index">
        <div class="article_header">
          <p><img :src="$oss.url + item.icon " alt="" width="40" height="40" style="margin-right:10px;"> {{item.title}}
          </p>
